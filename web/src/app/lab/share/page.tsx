...
export default function ShareableLabPage() {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Music Lab</h1>
          <p className="text-lg text-gray-600 mb-2">
            Explore music with our collection of tools: metronome, sequencer, piano, and chord explorer.
          </p>
          <p className="text-sm text-gray-500">
            Part of <span className="font-semibold">SongBuddy</span> - Your offline Christian songwriting companion
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            Want more songwriting tools? Check out the full{' '}
            <a 
              href="/" 
